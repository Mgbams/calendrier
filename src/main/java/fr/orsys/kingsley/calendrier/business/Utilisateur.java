...
public class Utilisateur {
	...
	public Utilisateur(Long id, String nom, @NotBlank(message = "Merci de préciser votre prénom") String prenom,
			@NotBlank(message = "Merci de préciser une adresse email") @Pattern(regexp = "^[A-Za-z0-9]([A-Za-z0-9-.])+[A-Za-z0-9]@orsys.fr$", message = "Votre adresse doit faire partie du nom de domaine orsys.fr") String email,
			@Size(min = 3, message = "Le mot de passe doit comporter au moins trois caractères") String motDePasse,
			@NotNull(message = "Merci de choisir un thème") Theme theme, int nbPoints,
